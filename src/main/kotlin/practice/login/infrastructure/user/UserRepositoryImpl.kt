...
class UserRepositoryImpl(
  ...
  override fun findAccountNameByUserId(userId: UserId): UserAccountName =
    userDao.findAccountNameByUserId(userId) ?: throw Exception("User Not Found")

  override fun existByUserId(userId: UserId): Boolean =
    userDao.existByUserId(userId)
}